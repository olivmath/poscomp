...
- Name: historico.spec.ts >> /historico/:id inexistente → redirect /historico
- Location: tests/e2e/historico.spec.ts:84:5
...
=========================== logs ===========================
waiting for navigation to "/historico" until "load"
  navigated to "http://localhost:5174/historico/id-nao-existe-xyz"
============================================================
```
